...
export const faqEntries: FaqEntry[] = [
  ...
  },
  {
    ...
    details: [
      ...
      {
        en: "**Attendance matters too.** Penalties apply to **consecutive missed season weeks**: first 2 misses are free, then **-4, -8, -16, -32, -64 season-score points**, capped at **-128 points**. If you play again, the miss counter resets.",
        de: "**Auch die Teilnahme zählt.** Die Strafe gilt für **aufeinanderfolgende verpasste Saisonwochen**: Die ersten 2 Fehlwochen sind frei, danach **-4, -8, -16, -32, -64 Saison-Score-Punkte**, gedeckelt bei **-128 Punkten**. Wenn du wieder spielst, wird der Fehlzähler zurückgesetzt.",
      },
    ],
  },
  {
